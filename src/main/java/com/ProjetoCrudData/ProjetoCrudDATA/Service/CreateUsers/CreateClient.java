...
public class CreateClient {
    ...
    private UserRepository userRepository; // Dependência do repositório para salvar usuários no banco

    // Construtor para injetar o UserRepository no serviço
    public CreateClient(UserRepository userRepository){
        this.userRepository = userRepository;
    }

    // Metodo para criar um cliente no sistema
    public void createClient(){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Welcome to menu Register!");

        // Captura os dados do novo cliente via entrada do usuário
        ...
        // Cria um novo objeto User com tipo Client
        User users = new User(CPF, UserType.Client, nickname, password, name, email);
